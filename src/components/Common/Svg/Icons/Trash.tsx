...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path d="M3.75 5.25H20.25" stroke="#F3213B" strokeWidth="1.5" strokeMiterlimit={10} strokeLinecap="round" />
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M12 8.25V18.75" stroke="#F3213B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M8.625 8.25L9 18.75" stroke="#F3213B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M15.375 8.25L15 18.75" stroke="#F3213B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
